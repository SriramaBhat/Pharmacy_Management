...
class ViewStocks:
    def __init__(self, conn, emp_type):
        ...
        self.button1 = self.add_button("Transactions", 475, 540)
        self.button2 = self.add_button("Logout", 675, 540)
        self.button3 = self.add_button("Order by Price", 75, 540)
        self.button4 = self.add_button("Order by Name", 275, 540)
